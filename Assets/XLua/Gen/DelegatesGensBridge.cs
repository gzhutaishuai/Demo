...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(Item p0)
		{
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(UnityEngine.Events.UnityAction<Item>))
			{
			    return new UnityEngine.Events.UnityAction<Item>(__Gen_Delegate_Imp0);
			}
